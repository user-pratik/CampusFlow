...
/** Map agent names to simple icons */
...
export default function Dock() {
  ...
  return (
    <div className="absolute bottom-0 left-1/2 -translate-x-1/2 mb-4 z-9999">
      <div className="flex items-center gap-1 px-3 py-2 rounded-2xl bg-zinc-900/80 backdrop-blur-xl border border-white/10 shadow-2xl">
        {/* Pinned apps: Gmail, WhatsApp, GPA */}
        <button
          onClick={spawnEmail}
          className="group relative flex items-center justify-center w-12 h-12 rounded-xl transition-all hover:bg-white/10"
          title="Open Gmail"
        >
        ...
        {minimizedWindows.map((win) => (
          <button
            ...
            className={`group relative flex items-center justify-center w-12 h-12 rounded-xl transition-all hover:bg-white/10 ${
              activeWindowId === win.id ? "bg-white/15" : ""
            }`}
        ...
        {/* App Grid button (Show Applications) */}
        <button
